...
$("#chatsettings").append("<div class='Toggles'><input type='checkbox' id='leftchat' class='Toggle-checkbox'><label for='leftchat' class='Toggle-label'>Right Chat</label></div>");
